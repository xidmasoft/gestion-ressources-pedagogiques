...
<div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-4">
    <h1 class="h3 mb-0">Ajouter une Ressource</h1>
...
<div class="card">
    <div class="card-body">
        <form action="/index.php?page=resources&action=create" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="mb-4 p-3 bg-light border rounded">
                <label for="file" class="form-label fw-bold">Sélectionner un fichier <span class="text-danger">*</span></label>
